...
@section('title', 'Reset Password - SGR')
...
<div class="w-full max-w-md" style="animation: simpleFadeIn 0.4s ease-out both;">
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-br from-maroon-600 to-maroon-700 px-8 py-8 text-center">
            ...
            <p class="text-maroon-100 text-sm mt-1">We will send you a reset link</p>
        </div>
        ...
        <div class="p-8">
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('login') }}" class="inline-flex items-center gap-1 text-sm font-medium text-maroon-600 hover:text-maroon-700 transition-colors">
