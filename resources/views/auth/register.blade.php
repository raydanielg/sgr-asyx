...
<div class="w-full max-w-md" style="animation: simpleFadeIn 0.4s ease-out both;">
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-br from-maroon-600 to-maroon-700 px-8 py-8 text-center">
            ...
            <p class="text-maroon-100 text-sm mt-1">Join the SGR system</p>
        </div>
        ...
        <div class="p-8">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus
                            class="w-full pl-11 pr-4 py-2.5 rounded-lg border @error('name') border-red-300 ring-2 ring-red-100 @else border-gray-200 @enderror focus:border-maroon-500 focus:ring-2 focus:ring-maroon-200 outline-none transition-all text-sm"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email"
                            class="w-full pl-11 pr-4 py-2.5 rounded-lg border @error('email') border-red-300 ring-2 ring-red-100 @else border-gray-200 @enderror focus:border-maroon-500 focus:ring-2 focus:ring-maroon-200 outline-none transition-all text-sm"
            ...
            <p class="text-center text-sm text-gray-500">
                ...
                <a href="{{ route('login') }}" class="font-semibold text-maroon-600 hover:text-maroon-700 transition-colors">Sign in</a>
            </p>
        </div>
    </div>
